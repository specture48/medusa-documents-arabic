...
export function generateHeader(
  ...
  doc
    ...
    .text(`CR Number: ${storeDetails?.cr_number}`, 200, y + 30, {
      align: "right",
    })
    .text(`VAT Number: ${storeDetails?.vat_number}`, 200, y + 45, {
      align: "right",
    });
  ...
  doc.text(`${documentSettings.storeAddress?.address_1}`, 390, y + 60, {
    align: "right",
    width: 150,
  });
